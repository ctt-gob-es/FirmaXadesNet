...
namespace Microsoft.Xades
{
    ...
    public class Cert
    {
        ...
        public bool HasChanged()
        {
            ...
            if (IssuerSerial != null && IssuerSerial.HasChanged()) retVal = true;
        ...
        public void LoadXml(XmlElement xmlElement)
        {
            ...
            if (xmlElement.HasAttribute("URI")) URI = xmlElement.GetAttribute("URI");
            ...
            if (xmlNodeList.Count == 0) throw new CryptographicException("CertDigest missing");
            CertDigest = new DigestAlgAndValueType("CertDigest");
            CertDigest.LoadXml((XmlElement) xmlNodeList.Item(0));

            xmlNodeList = xmlElement.SelectNodes("xsd:IssuerSerial", xmlNamespaceManager);
            if (xmlNodeList.Count == 0) throw new CryptographicException("IssuerSerial missing");
            IssuerSerial = new IssuerSerial();
        ...
        public XmlElement GetXml()
        {
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "Cert",
                XadesSignedXml.XadesNamespaceUri);
            retVal.SetAttribute("xmlns:ds", SignedXml.XmlDsigNamespaceUrl);

            if (!string.IsNullOrEmpty(URI)) retVal.SetAttribute("URI", URI);
