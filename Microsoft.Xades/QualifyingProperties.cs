...
namespace Microsoft.Xades
{
    ...
    public class QualifyingProperties
    {
        ...
        public bool HasChanged()
        {
            ...
            if (!string.IsNullOrEmpty(Target)) retVal = true;

            if (SignedProperties != null && SignedProperties.HasChanged()) retVal = true;

            if (UnsignedProperties != null && UnsignedProperties.HasChanged()) retVal = true;
        ...
        public void LoadXml(XmlElement xmlElement, XmlElement counterSignedXmlElement)
        {
            ...
            if (xmlNodeList.Count == 0) throw new CryptographicException("SignedProperties missing");
            SignedProperties = new SignedProperties();
        ...
        public XmlElement GetXml()
        {
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "QualifyingProperties",
