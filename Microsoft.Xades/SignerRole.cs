...
namespace Microsoft.Xades
{
    ...
    public class SignerRole
    {
        ...
        public bool HasChanged()
        {
            ...
            if (ClaimedRoles != null && ClaimedRoles.HasChanged()) retVal = true;

            if (CertifiedRoles != null && CertifiedRoles.HasChanged()) retVal = true;
        ...
        public XmlElement GetXml()
        {
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "SignerRole",
