...
namespace Microsoft.Xades
{
    ...
    public class IssuerSerial
    {
        ...
        public bool HasChanged()
        {
            ...
            if (!string.IsNullOrEmpty(X509IssuerName)) retVal = true;

            if (!string.IsNullOrEmpty(X509SerialNumber)) retVal = true;
        ...
        public void LoadXml(XmlElement xmlElement)
        {
            ...
            if (xmlNodeList.Count == 0) throw new CryptographicException("X509IssuerName missing");
            X509IssuerName = xmlNodeList.Item(0).InnerText;

            xmlNodeList = xmlElement.SelectNodes("ds:X509SerialNumber", xmlNamespaceManager);
            if (xmlNodeList.Count == 0) throw new CryptographicException("X509SerialNumber missing");
        ...
        public XmlElement GetXml()
        {
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "IssuerSerial",
                XadesSignedXml.XadesNamespaceUri);
            retVal.SetAttribute("xmlns:ds", SignedXml.XmlDsigNamespaceUrl);

            bufferXmlElement = creationXmlDocument.CreateElement(XadesSignedXml.XmlDSigPrefix, "X509IssuerName",
            ...
            bufferXmlElement = creationXmlDocument.CreateElement(XadesSignedXml.XmlDSigPrefix, "X509SerialNumber",
                SignedXml.XmlDsigNamespaceUrl);
            bufferXmlElement.SetAttribute("xmlns:xades", XadesSignedXml.XadesNamespaceUri);
