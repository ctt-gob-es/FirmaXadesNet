...
namespace Microsoft.Xades
{
    ...
    public class SignedSignatureProperties
    {
        ...
        public void LoadXml(XmlElement xmlElement)
        {
            ...
            if (xmlNodeList.Count == 0) throw new CryptographicException("SigningTime missing");
            ...
            if (xmlNodeList.Count == 0) throw new CryptographicException("SigningCertificate missing");
            SigningCertificate = new SigningCertificate();
        ...
        public XmlElement GetXml()
        {
            ...
            retVal = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "SignedSignatureProperties",
            ...
            bufferXmlElement = creationXmlDocument.CreateElement(XadesSignedXml.XmlXadesPrefix, "SigningTime",
                XadesSignedXml.XadesNamespaceUri);
